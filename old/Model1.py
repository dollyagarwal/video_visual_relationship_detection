    ...
    def forward(self, images,captions):
        ...
        for i in range(images.shape[0]):
          ...
          if i==0:
            ...
            batch_features = torch.cat((batch_features,features.unsqueeze(0)),axis=0)

        # Discard the <end> word to avoid predicting when <end> is the input of the RNN
        captions = captions[:, :-1]

        # Initialize the hidden state
        batch_size = features.shape[0]  # features is of shape (batch_size, image sequences, embed_size)
